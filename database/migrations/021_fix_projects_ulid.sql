-- Migration: 021_fix_projects_ulid
-- Description: Change projects table from UUID to char(26) for ULID support
-- Date: 2026-02-23

-- First, drop the existing projects data since we can't convert UUID to ULID
-- (They have different formats and lengths)
...
-- Recreate projects table with ULID format (char(26))
CREATE TABLE projects (
    ...
    tech_leader_id VARCHAR(26),
    product_leader_id VARCHAR(26),
...
-- Insert test data with ULID format IDs
